...
from train.train_simple_baseline import train, test
...
def main_simple_baseline(args=args, configs=configs):
    ...
    # begin train
    print("Begin the {} time's training, Dataset:{}, Source Domain {}, Target Domain {}".format(args.train_time,
                                                                                                 configs[
                                                                                                     "DataConfig"][
                                                                                                     "dataset"],
                                                                                                 args.source_domains,
